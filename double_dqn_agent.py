...
class DoubleDQNAgent(BaseAgent):
    ...
    def __init__(self, state_size, action_size, seed, agent_configuration):
        ...
        # Q-Network
        self.qnetwork_local = QNetwork(state_size, action_size, seed, agent_configuration["network"]["hidden_layers"]).to(device)
        self.qnetwork_target = QNetwork(state_size, action_size, seed, agent_configuration["network"]["hidden_layers"]).to(device)
